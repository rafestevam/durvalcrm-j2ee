...
public class Mensalidade {
    ...
    // Factory method para recriar mensalidade a partir dos dados da entidade
    public static Mensalidade fromEntity(UUID id, UUID associadoId, int mesReferencia, int anoReferencia, 
            BigDecimal valor, StatusMensalidade status, LocalDate dataVencimento, Instant dataPagamento,
            String qrCodePix, String identificadorPix, Instant criadoEm, FormaPagamento metodoPagamento) {
        Mensalidade mensalidade = new Mensalidade();
        mensalidade.id = id;
        mensalidade.associadoId = associadoId;
        mensalidade.mesReferencia = mesReferencia;
        mensalidade.anoReferencia = anoReferencia;
        mensalidade.valor = valor;
        mensalidade.status = status;
        mensalidade.dataVencimento = dataVencimento;
        mensalidade.dataPagamento = dataPagamento;
        mensalidade.qrCodePix = qrCodePix;
        mensalidade.identificadorPix = identificadorPix;
        mensalidade.criadoEm = criadoEm;
        mensalidade.metodoPagamento = metodoPagamento;
        return mensalidade;
    }
